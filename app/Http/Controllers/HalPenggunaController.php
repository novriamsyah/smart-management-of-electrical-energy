...
class HalPenggunaController extends Controller
{
    ...
    public function halamanPengguna()
    {
    	...
    	return view('halaman_pengguna.halaman_pengguna', compact('penggunas'));
    }
    ...
    public function tambahPengguna()
    {
    	...
    	return view('halaman_pengguna.halaman_tambah_pengguna', compact('max_code'));
    }
    ...
    public function editPengguna($id)
    {
    	$penggunas = User::find($id);
        // $outlets = Outlet::all();
    	return view('halaman_pengguna.halaman_edit_pengguna', compact('id', 'penggunas'));
    }
