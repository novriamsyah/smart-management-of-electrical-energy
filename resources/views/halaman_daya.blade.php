...
<script>
   ...
   var updateChart_daya = function() {
   $.ajax({
     type: "GET",
     dataType: "json",
     url: '{{ route('chart_daya') }}',
     headers: {
       'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
     },
     success: function(data) {

       myChart4.data.labels = data.wkt;
       myChart4.data.datasets[0].data = data.daya;
       myChart4.update();
     },
     error: function(data){
       console.log(data);
 ...
 (function($) {
   ...
   $.ajax({
     ...
     success: function(data) {
       ...
       myChart2.data.labels = data.wkt;
       myChart2.data.datasets[0].data = data.energi;
       myChart2.update();
     },
     error: function(data){
       console.log(data);
