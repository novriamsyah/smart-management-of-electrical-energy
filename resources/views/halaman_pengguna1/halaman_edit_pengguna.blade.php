                    ...
                    <div class="form-validation">
                        <form class="form-valide" action="{{ url('/update_pengguna/'.$id) }}" method="post" enctype="multipart/form-data" name="edit_pengguna_form">
                            ...
                            {{-- <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <input type="text" class="form-control" id="val-password" name="password" placeholder="Masukkan Password" value="{{ $penggunas->password }}">
                                </div>
                            </div> --}}
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    <select class="form-control" id="val-role" name="role">
                                        ...
                                        <option value="admin_low">Admin_low</option>
                                        @else
                                        <option value="admin">Admin</option>
                                        <option value="admin_low" selected="">Admin_low</option>
                                        @endif
                                    </select>
                                </div>
                            </div>
