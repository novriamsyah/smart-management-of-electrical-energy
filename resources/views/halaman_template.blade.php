    ...
    <div id="main-wrapper">
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ url('/dashboard') }}" style="padding-bottom: 50px; padding-left:13px; padding-top:20px;">
                    <b class="logo-abbr"><img src="{{ asset('icons/logo8.png') }}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('icons/logo8.png') }}" width="207" alt=""></span>
                    <span class="brand-title">
                        <img src="{{ asset('icons/logo8.png') }}" width="207" alt="">
                    </span>
                </a>
            </div>
        </div>
                        ...
                        <li class="icons dropdown">
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        @if(auth()->user()->role == 'admin' || auth()->user()->role == 'admin_low')
                                        <li>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        <li class="mega-menu mega-menu-sm">
                            ...
                            <ul aria-expanded="false">
                                ...
                                {{-- <li><a href="{{ url('/dashboarduser1') }}">Pelanggan 2</a></li> --}}
                                {{-- <li><a href="{{ url('/dashboarduser2') }}">Pengguna 3</a></li> --}}
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ url('/device') }}">Ruang Pengontrolan</a></li>
                            <li><a href="{{ url('/kelola_pulsa') }}">Isi Pulsa Listrik</a></li>
                            {{-- <li><a href="{{ url('/kelola_paket') }}">Kelola Paket</a></li> --}}
                            {{-- <li><a href="{{ url('/kelola_outlet') }}">Kelola Outlet</a></li> --}}
                        </ul>
                    </li>
                    @endif
                    @if(auth()->user()->role == 'admin_low')
                    <li class="nav-label">Kelola Data</li>
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-th-large menu-icon"></i><span class="nav-text">Kelola Data</span>
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ url('/laporan_pf') }}">Laporan Power Factor</a></li>
                            <li><a href="{{ url('/laporan_daya') }}">Laporan Daya</a></li>
                            <li><a href="{{ url('/laporan_energi') }}">Laporan Energi</a></li>
                            <li><a href="{{ url('/hapus_halaman') }}">Hapus Laporan</a></li>
